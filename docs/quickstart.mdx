...
<CardGroup>
  ...
  <Card title="2. Choose Algorithm" icon="git-branch">
    Pick from 20+ matching algorithms
  </Card>
  <Card title="3. Configure" icon="settings">
    Adjust thresholds and parameters
  </Card>
  <Card title="4. Match" icon="zap">
...
<CardGroup cols={2}>
  <Card title="Compare Algorithms" icon="git-compare-alt" href="/docs/models">
    Test different algorithms on your images
  </Card>

  <Card title="Custom Configuration" icon="file-code" href="/docs/configuration">
  ...
  <Card title="Troubleshoot Issues" icon="life-buoy" href="/docs/troubleshooting">
...
<Card title="Try HuggingFace Demo" icon="play-circle" href="https://huggingface.co/spaces/Realcat/image-matching-webui">
