...
<Alert type="info">
<strong>Note:</strong> This WebUI no longer maintains matching algorithms. All matchers are maintained in the <a href="https://github.com/gmberton/vismatch">vismatch</a> repository by <a href="https://github.com/gmberton">@gmberton</a>. To add new matchers or algorithms, please contribute to the vismatch repository.
</Alert>
...
1. Create or update MDX files in `docs/` directory
2. Update `mint.json` to include new pages in navigation
...
|-----------|-------------|
| `imcui/` | Main package |
| `imcui/cli/` | CLI entry point |
| `imcui/ui/` | Gradio-based web interface |
| `imcui/api/` | Core matching API |
| `imcui/config/` | Configuration files |
...
- [GitHub Repository](https://github.com/Vincentqyw/image-matching-webui)
- [Issue Tracker](https://github.com/Vincentqyw/image-matching-webui/issues)
